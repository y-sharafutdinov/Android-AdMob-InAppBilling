...
package com.example.admobinappbilling.util;
 ...
 * inAppBillingService, which will leak unless you dispose of it correctly. If you created
...
public class IabHelper {
    ...
    // Connection to the inAppBillingService
     ...
     *
     * @param ctx Your application or Activity context. Needed to bind to the in-app billing inAppBillingService.
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        // Connection to IAB inAppBillingService
        logDebug("Starting in-app billing setup.");
        mServiceConn = new ServiceConnection() {
            @Override
            public void onServiceDisconnected(ComponentName name) {
                logDebug("Billing inAppBillingService disconnected.");
                mService = null;
            }
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                if (mDisposed) return;
                logDebug("Billing inAppBillingService connected.");
        ...
        if (intentServices != null && !intentServices.isEmpty()) {
            // inAppBillingService available to handle that Intent
            mContext.bindService(serviceIntent, mServiceConn, Context.BIND_AUTO_CREATE);
        }
        else {
            // no inAppBillingService available to handle that Intent
            if (listener != null) {
                listener.onIabSetupFinished(
                        new IabResult(BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE,
                                "Billing inAppBillingService unavailable on device."));
            }
        }
    }
     ...
     * used by it such as inAppBillingService connections. Naturally, once the object is
    ...
    public void dispose() throws IabAsyncInProgressException {
        ...
        if (mServiceConn != null) {
            logDebug("Unbinding from inAppBillingService.");
...
//                Signature verification. Disabled for development purpose
