...
/**
 * InAppBillingService is the inAppBillingService that provides in-app billing version 3 and beyond.
 * This inAppBillingService provides the following features:
